...
class BaseModel(nn.Module):
    ...
    def _predict_once(self, x1, x2=None, profile=False, visualize=False):
        """
        Perform a forward pass through the network.

        Args:
            x1 (torch.Tensor): The input visible tensor to the model.
            x2 (torch.Tensor, optional): The input infrared tensor to the model.
            profile (bool):  Print the computation time of each layer if True, defaults to False.
            visualize (bool): Save the feature maps of the model if True, defaults to False.
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolov8n.yaml', ch=3, ch2=3, nc=None,
