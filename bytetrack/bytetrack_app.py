...
with col_ctrl:
    ...
    line_y_ratio = st.slider(
        ...
        help="Posisi garis horizontal relatif terhadap tinggi video (misal 0.55 = 55% dari atas)."
    )
    ...
    frame_stride = st.select_slider(
        ...
        options=[1, 2, 3],
        value=1,
        help="1 = Proses setiap frame (Sangat disarankan untuk ByteTrack agar Kalman Filter akurat)."
    )
                ...
                while cap.isOpened():
                    ...
                    if processed_count % 5 == 0 or frame_idx >= total_frames:
                        ...
                        live_preview.image(
                            ...
                            caption="Live ByteTrack Preview",
                            width="stretch"
                        )
